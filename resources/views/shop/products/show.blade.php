    ...
    <section class="item-details section">
        <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="category-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ $category->image_url }}" id="current" alt="#">
                                </div>
                                @if($gallery)
                                <div class="images">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="category-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> <a href="javascript:void(0)">{{ $category->category->name}}
                                    </a></p>
                            <h3 class="price">
                                {{ $category->price_formatted }}
                                @if( $category->compare_price)
                                <span>{{ $category->compare_price_formatted }}</span>
                                @endif
                            </h3>
                            <p class="info-text">{{ $category->short_description }}</p>
            ...
            <div>
                ...
                <div class="row">
                    @foreach ($category->category->categories()->where('id', '<>', $category->id)->orderBy('name')->get() as $similar_category)
                    <div class="col-lg-3 col-md-6 col-12">
                        <x-category-card :category="$similar_category" />
                    </div>
                    @endforeach
                </div>
            </div>
